...
//Action Creators
export const acceptFollow = (userId: string) => ({type: 'FOLLOW', userId} as const)//Action Create
export const acceptUnfollow = (userId: string) => ({type: 'UNFOLLOW', userId} as const)//Action Create
