...
type HeaderConnectType = HeaderMapStateToPropsType &
...
export type DialogsType = DialogsMapStateToPropsType &
...
export type ProfileConnectType = ProfileMapStateToPropsType &
...
export type NavbarType = NavbarMapStateToPropsType &
  NavbarMapDispatchToPropsType; /*{
    sidebar: SidebarType
}*/
...
export type UsersClassContainerType = UsersMapStateToPropsType &
